...
void Bluefox2::SetSerial(std::string serial) {
    serial_ = serial;
...
bool Bluefox2::GrabImage(sensor_msgs::msg::Image &image_msg) {
...
void Bluefox2::Configure(bluefox2::Config config) {
